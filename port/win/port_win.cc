...
DIR* opendir(const char* name) {
  ...
  strncpy_s(dir->entry_.d_name, sizeof(dir->entry_.d_name), dir->data_.name, strlen(dir->data_.name));
...
struct dirent* readdir(DIR* dirp) {
  ...
  strncpy_s(dirp->entry_.d_name, sizeof(dirp->entry_.d_name), dirp->data_.name, strlen(dirp->data_.name));
